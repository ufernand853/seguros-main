...
const DEFAULT_PLANS = [
  {
    ...
    interval: "monthly",
    limits: { users: 3, clients: 100, storageMb: 1024 },
    active: true,
  },
  {
    _id: "plan-pro",
    ...
    currency: MERCADOPAGO_CURRENCY,
    interval: "monthly",
    limits: { users: 10, clients: 1000, storageMb: 5120 },
    active: true,
  },
  {
    _id: "plan-empresa",
    slug: "empresa",
    name: "Pro",
    description: "Plan personalizado con formulario de contacto comercial.",
    price: 0,
    currency: MERCADOPAGO_CURRENCY,
    interval: "monthly",
    limits: { users: 50, clients: 0, storageMb: 20480 },
    active: false,
  },
];
