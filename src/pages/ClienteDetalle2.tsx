...
const MOCK: Cliente[] = [
  {
    ...
    pais: "Uruguay",
    contacto: "Juan Pérez - Compras",
    notas: "Cliente con crédito estándar.",
    docFiles: [{ name: "RUT_Acme.pdf", type: "application/pdf", size: 120000 }],
    otherDocs: [{ name: "Habilitacion.pdf", type: "application/pdf", size: 98000 }],
  },
  {
    id: "2",
    nombre: "Casarone Agroindustrial S.A.",
    rut: "RUT 21.222.222-001",
    ciudad: "Rio Branco",
...
export default function ClienteDetalle() {
  ...
  const onSave = () => {
    if (!isEditing) return; // Guardar deshabilitado si no está en edición
